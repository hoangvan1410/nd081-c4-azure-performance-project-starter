...
handler = AzureLogHandler(
    connection_string="InstrumentationKey=42198c9f-43fe-44f6-a458-1d17a9ca83cc;IngestionEndpoint=https://westus2-2.in.applicationinsights.azure.com/;LiveEndpoint=https://westus2.livediagnostics.monitor.azure.com/;ApplicationId=555655ae-2e0f-44de-b5d1-2e9d65854e2e"
)
...
try:
    if "REDIS_PWD" in os.environ:
        r = redis.StrictRedis(host='172.19.0.3',
                        port=6379,
                        password=os.environ['REDIS_PWD'])
    else:
        r = redis.Redis('172.19.0.3')
    r.ping()
